globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getCookie, setCookie, getRequestURL, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, readBody } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/h3/dist/index.mjs';
import axios from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/axios/index.js';
import { createRenderer } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/devalue/index.js';
import destr from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/ohash/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/defu/dist/defu.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _1yCwfe7BRI = (function(nitro) {
...
const _7hLlPu = defineEventHandler((event) => {
  var _a;
  ...
  if (!token && ((_a = event.node.req.url) == null ? void 0 : _a.startsWith("/memories"))) {
...
const _lazy_Lp9ZDo = () => Promise.resolve().then(function () { return callback$1; });
const _lazy_U3BE1x = () => Promise.resolve().then(function () { return index$1; });
const _lazy_nNuxfk = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _7hLlPu, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/callback', handler: _lazy_Lp9ZDo, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth/logout', handler: _lazy_U3BE1x, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_nNuxfk, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nNuxfk, lazy: true, middleware: false, method: undefined }
];
...
const callback = defineEventHandler(async (event) => {
  ...
  return sendRedirect(event, redirectTo != null ? redirectTo : "/");
});
...
const getClientManifest = () => import('/home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/caio.vinicius/nlw-vue-projects/nlw-spacetime-nuxt/web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
